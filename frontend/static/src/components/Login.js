    ...
    <div className="container mx-auto h-full flex justify-center items-center">
        ...
        <div className="w-1/3">
            ...
            <form onSubmit={handleSubmit} className="border-teal p-8 border-t-12 bg-white mb-6 rounded-lg shadow-lg">
                <div className="mb-4">
                    <label htmlFor="username" className="font-bold text-gray-darker block mb-2">Username</label>
                    <input type='text' className='inputField' name='username' id='username' placeholder='username' onChange={handleInput} required value={state.username} className="block appearance-none w-full bg-white border border-gray-light hover:border-gray px-2 py-2 rounded shadow"/>
                </div>
            ...
            <div className="text-center">
                <p className="text-gray-dark text-sm">Don't have an account? <a href="#" className="no-underline text-blue font-bold">Create an Account</a>.</p>
            </div>
        </div>
