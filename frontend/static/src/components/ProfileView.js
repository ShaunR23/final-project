...
function ProfileView(){
    ...
    <div class="container flex justify-center py-20">
        <div class="p-3 bg-white rounded-xl max-w-lg hover:shadow overflow-hidden">
            <div class="flex justify-between w-full"> <img src="https://i.imgur.com/CeVfZyY.jpg" width="150" class="rounded-lg" />
                <div class="ml-2">
                    <div class="p-3">
                        <h3 class="text-2xl">Shaun</h3> <span>sub text</span>
                    </div>
                    <div class="flex justify-between items-center p-3 bg-gray-200 rounded-lg">
                        <div class="mr-3"> <span class="text-gray-400 block">Total Right</span> <span class="font-bold text-black text-xl">34</span> </div>
                        <div class="mr-3"> <span class="text-gray-400 block">Total Attempts</span> <span class="font-bold text-black text-xl">940</span> </div>
                        <div> <span class="text-gray-400 block">Percentage or grade?</span> <span class="font-bold text-black text-xl">8.9</span> </div>
                    </div>
                </div>
            </div>
